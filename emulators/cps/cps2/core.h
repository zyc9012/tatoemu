...
public:
    ...
    void setAudioSampleRate(u32 sampleRate) override { /* Sound skipped for now */ }
    void setAudioVolume(float volume) override { /* Sound skipped for now */ }
    ...
    // CPS2 games were designed for 4:3 CRT displays with non-square pixels
