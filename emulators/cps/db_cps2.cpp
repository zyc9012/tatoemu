...
static const ROMEntry progear_roms[] = {
    ...
    { "pga-simm.01c",  0x200000, 0x452f98b0, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pga-simm.01d",  0x200000, 0x9e672092, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pga-simm.01a",  0x200000, 0xae9ddafe, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pga-simm.01b",  0x200000, 0x94d72D94, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pga-simm.03c",  0x200000, 0x48a1886d, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pga-simm.03d",  0x200000, 0x172d7e37, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pga-simm.03a",  0x200000, 0x9ee33d98, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pga-simm.03b",  0x200000, 0x848dee32, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pga.01",        0x020000, 0xbdbfa992, ROMType::SOUND_PROGRAM, 0 },
    { "pga-simm.05a",  0x200000, 0xc0aac80c, ROMType::SOUND_SAMPLE, 0 },
    { "pga-simm.05b",  0x200000, 0x37a65d86, ROMType::SOUND_SAMPLE, 0 },
    { "pga-simm.06a",  0x200000, 0xd3f1e934, ROMType::SOUND_SAMPLE, 0 },
    { "pga-simm.06b",  0x200000, 0x8b39489a, ROMType::SOUND_SAMPLE, 0 },
...
static const ROMEntry choko_roms[] = {
    ...
    { "tkoj1_d.simm1", 0x200000, 0x6933377d, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "tkoj1_c.simm1", 0x200000, 0x7f668950, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "tkoj1_b.simm1", 0x200000, 0xcfb68ca9, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "tkoj1_a.simm1", 0x200000, 0x437e21c5, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "tkoj3_d.simm3", 0x200000, 0xa9e32b57, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "tkoj3_c.simm3", 0x200000, 0xb7ab9338, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "tkoj3_b.simm3", 0x200000, 0x4d3f919a, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "tkoj3_a.simm3", 0x200000, 0xcfef17ab, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "tko.01",        0x020000, 0x6eda50c2, ROMType::SOUND_PROGRAM, 0 },
    { "tkoj5_a.simm5", 0x200000, 0xab45d509, ROMType::SOUND_SAMPLE, ROM_FLAG_INTERLEAVE },
    { "tkoj5_b.simm5", 0x200000, 0xfa905c3d, ROMType::SOUND_SAMPLE, ROM_FLAG_INTERLEAVE },
...
static const ROMEntry jyangoku_roms[] = {
    ...
    { "maj1_d.simm1",  0x200000, 0xba0fe27b, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "maj1_c.simm1",  0x200000, 0x2cd141bf, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "maj1_b.simm1",  0x200000, 0xe29e4c26, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "maj1_a.simm1",  0x200000, 0x7f68b88a, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "maj3_d.simm3",  0x200000, 0x3aaeb90b, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "maj3_c.simm3",  0x200000, 0x97894cea, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "maj3_b.simm3",  0x200000, 0xec737d9d, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "maj3_a.simm3",  0x200000, 0xc23b6f22, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "maj.01",        0x020000, 0x1fe8c213, ROMType::SOUND_PROGRAM, 0 },
    { "maj5_a.simm5",  0x200000, 0x5ad9ee53, ROMType::SOUND_SAMPLE, ROM_FLAG_INTERLEAVE },
    { "maj5_b.simm5",  0x200000, 0xefb3dbfb, ROMType::SOUND_SAMPLE, ROM_FLAG_INTERLEAVE },
...
static const ROMEntry mpang_roms[] = {
    ...
    { "mpn-simm.01c",  0x200000, 0x388db66b, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "mpn-simm.01d",  0x200000, 0xaff1b494, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "mpn-simm.01a",  0x200000, 0xa9c4857b, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "mpn-simm.01b",  0x200000, 0xf759df22, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "mpn-simm.03c",  0x200000, 0xdec6b720, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "mpn-simm.03d",  0x200000, 0xf8774c18, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "mpn-simm.03a",  0x200000, 0xc2aea4ec, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "mpn-simm.03b",  0x200000, 0x84d6dc33, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "mpn.01",        0x020000, 0x90c7adb6, ROMType::SOUND_PROGRAM, 0 },
    { "mpn-simm.05a",  0x200000, 0x318a2e21, ROMType::SOUND_SAMPLE, 0 },
    { "mpn-simm.05b",  0x200000, 0x5462f4e8, ROMType::SOUND_SAMPLE, 0 },
...
static const ROMEntry pzloop2_roms[] = {
    ...
    { "pl2-simm.01c",  0x200000, 0x137b13a7, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pl2-simm.01d",  0x200000, 0xa2db1507, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pl2-simm.01a",  0x200000, 0x7e80ff8e, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pl2-simm.01b",  0x200000, 0xcd93e6ed, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pl2-simm.03c",  0x200000, 0x0f52bbca, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pl2-simm.03d",  0x200000, 0xa62712c3, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pl2-simm.03a",  0x200000, 0xb60c9f8e, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pl2-simm.03b",  0x200000, 0x83fef284, ROMType::GRAPHICS, ROM_FLAG_INTERLEAVE },
    { "pl2.01",        0x020000, 0x35697569, ROMType::SOUND_PROGRAM, 0 },
    { "pl2-simm.05a",  0x200000, 0x85d8fbe8, ROMType::SOUND_SAMPLE, 0 },
    { "pl2-simm.05b",  0x200000, 0x1ed62584, ROMType::SOUND_SAMPLE, 0 },
