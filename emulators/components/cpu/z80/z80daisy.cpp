...
static struct z80_irq_daisy_chain *main_chain = NULL;
static struct z80_irq_daisy_chain *daisy_end = NULL;
...
{
    main_chain = (struct z80_irq_daisy_chain *)BurnMalloc(sizeof(struct z80_irq_daisy_chain) * 4);
    daisy_end = main_chain;
    memset(main_chain, 0, sizeof(struct z80_irq_daisy_chain) * 4);
